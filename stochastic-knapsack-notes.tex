\section{Stochastic Knapsack Problem --- Paper Notes}\label{sec:sk-notes}
...
\subsection{Dean, Goemans, and Vondr\'{a}k (2008): Approximating the Stochastic Knapsack Problem}

Published in \emph{Mathematics of Operations Research}, Vol.~33, No.~4, pp.~945--964~\cite{DeanGoemansVondrak2008}.
...
\subsubsection{Key Concept --- Adaptivity Gap}
...
\subsection{Barak and Talgam-Cohen (2026): Semi-Adaptivity Gaps and Improved Approximation}
...
\subsubsection{Key New Concept --- Semi-Adaptivity}
...
\subsubsection{Two New Gap Notions}
...
\subsubsection{Main Results --- Risky-SK}
...
\subsubsection{Main Results --- Non-Risky-SK}
...
\subsubsection{Algorithmic Improvements over DGV08}
...
\subsubsection{Technique --- Simplify-Equalize-Optimize}
...
\subsection{Relationship Between the Two Papers}
