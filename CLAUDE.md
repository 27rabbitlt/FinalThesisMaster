# CLAUDE.md — Final Thesis Master Project
...
- `post-adapt-solver/` — Exact solver for a posteriori, adaptive, and a priori stochastic TSP (see `post-adapt-solver/claude.md` for details)
