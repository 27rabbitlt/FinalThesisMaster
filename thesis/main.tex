...
least~$10/9$. Throughout the chapter, we only focus on symmetric instances.
We construct a family of instances with one stochastic
...
\[
  \frac{\optadapt}{\optpost}\le\frac{2+p}{2+p^2}.
\]
The right-hand side is maximized at $p=\sqrt6-2$, giving the bound
\[
...
In this section We now construct a family of instances with one stochastic vertex showing clairvoyance gap lower bound $10/9$.
We achieve this by making inactive and active realizations to have conflict 
optimal order to visit.  We construct three deterministic chains and a stochastic
vertex deciding which of two conflict patterns is cheaper.  The a posteriori tours
can choose between them but an adaptive policy cannot realize both optimal orders.
